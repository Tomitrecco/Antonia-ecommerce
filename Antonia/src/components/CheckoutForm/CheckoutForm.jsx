    ...
    return(
        <div className="Container">
            <form onSubmit={handleConfirm }className="Form">
                ...
                <label className="Label">
                    Telefono
                    <input className="Input" type="number" value={phone} onChange={({target})=>setPhone(target.value)} required/>
                </label>
                <label className="Label">
                    Email
                ...
                <div className="Label">
                    <button type="submit" className="Button-create">Crear Orden</button>
                </div>
            </form>
        </div>
    )
